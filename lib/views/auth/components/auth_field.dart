...
class AuthField extends StatefulWidget {
  ...
  final String icon;
    final Function(String?)? onSaved; // Correctly define the type for onSaved
  const AuthField({
    super.key,
...
class _AuthFieldState extends State<AuthField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      obscureText: widget.isPassword, // Always obscure if it's a password
      validator: (value) {
      ...
      decoration: InputDecoration(
        ...
        hintStyle: AppTypography.kLight12.copyWith(color: AppColors.kGreyHint),
        prefixIcon: Padding(
